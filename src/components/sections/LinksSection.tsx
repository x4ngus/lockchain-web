...
const LinksSection: React.FC = () => {
  return (
    /* This section pushes readers to source-of-truth docs; keep the framing humble and action oriented. */
    <Section
      kicker="Dig deeper"
    ...
    >
      <div className="lc-grid lc-grid--2">
        <article className="lc-card">
          {/* Card #1: emphasize README as the canonical narrative and quickstart. */}
        ...
        <article className="lc-card">
          {/* Card #2: focus on decisions and deeper documentation for evaluators. */}
